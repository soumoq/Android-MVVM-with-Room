...
public class SignUpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        googleSignIn = findViewById(R.id.sign_in_button1);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RC_SIGN_IN) {
            ...
            try {
                ...
                Toast.makeText(this, "Google signing successful", Toast.LENGTH_LONG).show();
                firebaseAuthWithGoogle(account.getIdToken());
                startActivity(new Intent(SignUpActivity.this, MainActivity.class));
                finish();
            } catch (ApiException e) {
                // Google Sign In failed, update UI appropriately
                Toast.makeText(this, "Google signing failed", Toast.LENGTH_LONG).show();
                // ...
            }
        }
    }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(SignUpActivity.this, "Google signing fail", Toast.LENGTH_LONG).show();
                        }
                        // ...
                    }
                });
